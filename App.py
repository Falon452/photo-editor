...
class ImageEffectsBar(ttk.Frame):
    ...
    def __create_widgets(self):
        ...
        self.draw_option = ttk.Combobox(self, textvariable=self.selected_shape  , width=self.button_width//2 , state="readonly")
        ...
        self.effect_option = ttk.Combobox(self, textvariable=self.selected_effect_option  , width=self.button_width//2 , state="readonly")
