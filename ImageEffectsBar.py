...
class ImageEffectsBar(ttk.Frame):
    ...
    def add_labels(self):
        self.filter_label = ttk.Label(self, text="Filters: ", borderwidth=2, relief="groove" ,width=10)
    ...
    def add_computional_photograpy(self):
        self.button = ttk.Button(self, text='Denoise', command=self.parent.img_UI.denoise, width=self.button_width//2)
        self.button.grid(row=0, column=12)

        self.button = ttk.Button(self, text='Inpaint', command=self.parent.img_UI.inpaint,
                                 width=self.button_width//2)
        self.button.grid(row=1, column=12)

        self.button = ttk.Button(self, text='HDR', command=self.parent.img_UI.hdr, width=self.button_width//2)
        self.button.grid(row=3, column=12)
    ...
    def __create_widgets(self):
        ...
        self.slider_label.grid(row=0, column=13, sticky=NE, rowspan=2)
        ...
        self.slider.grid(row=0, column=14, sticky=NE, rowspan=2)

        self.slider_label = ttk.Label(self, text='Zoom: ')
        self.slider_label.grid(row=2, column=13, sticky=SE, rowspan=2)
        ...
        self.slider_zoom.grid(row=2, column=14, sticky=SE, rowspan=2)
